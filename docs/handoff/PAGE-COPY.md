...
- **TV nodes** (in the interactive hub, `ChannelExplorer.tsx`): "Connected TV (CTV)" — "Reach cord-cutters on Roku, Hulu, and YouTube TV with broadcast-style ads and precise targeting." / "Broadcast TV" — **NOT AVAILABLE NOW** (badge with tooltip) — "Your video is made to broadcast quality — but broadcast is the one destination here we don't serve. We don't prepare videos for the air, and we don't buy or place airtime." · **[DISCLAIMER]** `BROADCAST_DISCLAIMER`, shown in the badge tooltip and again in an amber callout: "Good news: your video is made to broadcast-quality standards. What we don't do is prepare it for broadcast — we don't check videos against station clearance rules or broadcast regulations, and we don't buy or place airtime. If television is part of your plan, talk it through with your station and your campaign's counsel first. Airing a video is your call, and CampaignAI is not liable for its use on broadcast."
- The same badge and disclaimer render in `ui/TelevisionReach.tsx` (the non-interactive TV pair kept for reuse).
...
- Eyebrow "Where to share your video" · Heading "You made it. Now make it work everywhere." · Body "A finished video is the beginning, not the end. You're the one telling the story — we'll show you where it lands hardest, how to cut it for each place, and what's coming next as your reach grows." · sub-line "Recommendations, not placement: you own the video and decide where it runs."

### Channel chooser — `channels/ChannelChooser.tsx`
- Eyebrow "Where it should go" · Heading "Pick a channel. Get the playbook." · Body "One finished video works everywhere — but it works best when it's cut for each spot. Here's how we'd run it." · **placement note** (`CHANNELS_PLACEMENT_NOTE`): "Everything here is a recommendation for where to share the video you own. CampaignAI does not place videos or buy ads — the posting and any ad buys are yours to run."
- Field labels: "Best length · {value}" / "Format · {value}" / "One thing to know" (or "What we do and don't do here" on an unavailable channel) / "Works well with: {value}"
- **Channels (why / length / format / tips / pair):**
  ...
  - **Broadcast TV** — **NOT AVAILABLE NOW** (`BROADCAST_STATUS`, amber badge with tooltip in the panel, "Not available" chip in the picker) — "Traditional television still commands attention and a sense of credibility that's hard to buy anywhere else. It is also the one destination on this page we don't serve: your video is made to broadcast quality, but we don't prepare it for broadcast." · "15 or 30 sec, if a station accepts it" · "Produced to broadcast quality — not prepared for broadcast" · tips "Broadcast quality is about how the video looks and sounds. Broadcast clearance is a separate process, and it isn't one we run." / "We don't check videos against station clearance rules or broadcast regulations." / "We don't buy or place airtime, and we don't submit videos to stations." · works well with "Your station and your campaign's counsel, before anything airs." · **[DISCLAIMER]** `BROADCAST_DISCLAIMER`: "Good news: your video is made to broadcast-quality standards. What we don't do is prepare it for broadcast — we don't check videos against station clearance rules or broadcast regulations, and we don't buy or place airtime. If television is part of your plan, talk it through with your station and your campaign's counsel first. Airing a video is your call, and CampaignAI is not liable for its use on broadcast."

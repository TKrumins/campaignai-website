...
- ☐ Rebuild for engagement/interaction/clarity; responsible-design story; welcome feedback via structured channels; surveys/roundtables/events; link to Community. **(Held: structure rebuild pairs with the approved red-line wording below — building it before sign-off risks rework.)**
...
- 🔒 New "lines we won't cross" (sign-off) + persona-challenged copy (sign-off). **PROPOSED to Tom 2026-07-11 (awaiting ratification):** keep the 3 shipping lines (impersonate-without-consent · deceive-voters-how/when/where · never-train-major-models-on-your-data) + ADD two: **"We will never fabricate a quote, an event, or an endorsement that didn't happen."** and **"We will never let AI ship a video no human reviewed and approved."** Persona-challenge flags raised for Tom: satire/parody carve-out on the impersonation line? broaden voter-deception beyond how/when/where? Do NOT ship new lines until Tom signs off.
...
- **Tri-color panels pare-back (Tom 2026-07-11 — my rec given, awaiting his decision):** Tom feels the tri-color multi-partisan *panels/dividers between sections* read as a third theme competing with Patriot Gradient + Multi-Partisan gradient. My recommendation: consolidate to the two established gradients; keep the woven-ribbon motif only as an intentional accent (hero, About convergence, the new Community weave), and retire the repeated tri-color section dividers/toppers where they're just decoration. Audit + apply during this pass once Tom confirms.

/**
 * Storytelling Flywheel SVG graphic — archived 2026-04-20.
 * Desktop (horizontal) and Mobile (vertical) versions with pulsing animated dots.
 * To restore: import and render <DesktopFlywheel /> and <MobileFlywheel /> in StorytellingSection.
 */
...
export function DesktopFlywheel() {
  const p = "d";
  return (
    <svg
...
export function MobileFlywheel() {
  const p = "m";
  return (
    <svg

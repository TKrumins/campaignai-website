 ...
 */
const SPARKS: Spark[] = [
  { x: "3%", y: "6%", size: 14, color: "#FF3366", dur: "3.2s", glow: true },
  { x: "46%", y: "1%", size: 11, color: "#E8F4F8", dur: "2.6s" },
  ...
  { x: "-2%", y: "58%", size: 12, color: "#E8F4F8", dur: "3.3s" },
  { x: "-3%", y: "28%", size: 10, color: "#4D9FFF", dur: "2.5s", glow: true },
];
 ...
 */
const SPREAD: Spark[] = [
  { x: "49%", y: "24%", size: 12, color: "#E8F4F8", dur: "3.0s" },
  { x: "51%", y: "52%", size: 14, color: "#FF3366", dur: "2.7s", glow: true },
  { x: "48%", y: "76%", size: 11, color: "#4D9FFF", dur: "3.3s" },
  { x: "5%", y: "88%", size: 13, color: "#7AB8FF", dur: "2.9s", glow: true },
  { x: "22%", y: "93%", size: 12, color: "#FF3366", dur: "3.1s" },

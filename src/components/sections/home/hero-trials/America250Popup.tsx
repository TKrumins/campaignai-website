...
export function America250Popup({ className = "" }: { className?: string }) {
  return (
    <div
      ...
      style={{
        // Light Patriot-gradient ring (Batch 2): a navy fill inside a
        // soft Red/White/Blue border — patriotic without the gold.
        background:
    ...
    >
      ...
      <div className="relative px-4 pb-3.5 pt-3.5 text-center">
        ...
        <svg
          viewBox="0 0 24 24"
          className="a250-sparkle absolute -right-2 -top-3 h-7 w-7 fill-beacon-white drop-shadow"
          aria-hidden
        >
          <path d="M12 0l2.4 7.2L22 9.6l-6 4.8 2 8-6-4.8-6 4.8 2-8-6-4.8 7.6-2.4z" />
        </svg>

        <p className="font-heading text-sm font-extrabold uppercase tracking-wide patriot-gradient-text-bright">
          America 250 Special
        </p>
